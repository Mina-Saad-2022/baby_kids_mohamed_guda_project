...
<div id="header" class="header {{ $headerClass }}">
	...
	<div class="navbar-header">
		...
		@endif
		<a href="index.html" class="navbar-brand"><span class="navbar-logo"></span> <b>Baby</b> Kids</a>
		@if ($headerMegaMenu)
	...
	<ul class="navbar-nav navbar-right">
		...
		<li class="dropdown navbar-language">
			...
			<div class="dropdown-menu">
				...
				<a href="javascript:;" class="dropdown-item"><span class="flag-icon flag-icon-cn" title="cn"></span> Arabic</a>
		...
		<li class="dropdown navbar-user">
			<a href="#" class="dropdown-toggle" data-toggle="dropdown">
				...
				<span class="d-none d-md-inline">Mina Saad</span> <b class="caret"></b>
			</a>
